						...
						<div className="row">
							...
							<div className="col-md-4 order-1 order-md-2 align-self-center">
								<ul className="breadcrumb d-flex justify-content-md-end text-3-5">
									...
									<li className="active"> &nbsp; &nbsp; <i className='fa fa-chevron-right'></i> &nbsp; ECOMMERCE</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div className="row align-items-center justify-content-center pb-4 mb-5">
						...
						<div className="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
							...
							<p className="font-weight-light text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								...
								style={{ animationDelay: '450ms' }}>The "Online E-commerce Web application" Services department aims to offer solutions to build and transfer in an easy and efficient method in the digital age, as well as to help decrease the pressure on humans and the amount of time required. </p>
							<p className="pb-1 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								...
								style={{ animationDelay: '700ms' }}>It has a recognisable, well-designed user interface that is appealing, along with robust searching, inserting, and reporting functions. The store system's report creation feature makes it feasible for users to purchase products quickly by giving them a clear understanding of the numerous items that members have brought.
								</p>
							<p className="pb-1 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700"
								style={{ animationDelay: '700ms' }}>The "Online E-commerce Web application" Services department aims to offer solutions to build and transfer in an easy and efficient method in the digital age, as well as to help decrease the pressure on humans and the amount of time required. It offers services such the digitization of analogue artefacts, metadata management, digital preservation, and discovery and access of digital collections to support shop collections, digital initiatives, and external partner institution digital projects.</p>
						</div>
					</div>
