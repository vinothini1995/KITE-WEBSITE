						...
						<div className="row">
							...
							<div className="col-md-4 order-1 order-md-2 align-self-center">
								<ul className="breadcrumb d-flex justify-content-md-end text-3-5">
									...
									<li className="active"> &nbsp; &nbsp; <i className='fa fa-chevron-right'></i> &nbsp; Quiz</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div className="row align-items-center justify-content-center pb-4 mb-5">
						<div className="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
							...
							<p className="font-weight-light text-3-5 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								...
								style={{ animationDelay: '450ms' }}> This Android app's "QUIZ" feature provides information on the subjects. Each student must first register on the registration page.
								simply generating a login and password, using his or her name as the unique roll number. They must sign in each time to access their account after enrolling.
								</p>
							<p className="pb-1 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								...
								style={{ animationDelay: '700ms' }}>There are subjects available in the exam menu that we may choose from. Each test has 20 questions, and the correct answers receive points. References provide a general overview of the subjects' ideas and concepts.
								Thus, the primary goal of the research is to create an engaging mobile application based on the Android platform to conduct quizzes in the classroom for various technical courses.
								With future development, this app might be utilised for software company hiring processes, allowing them to quickly weed out individuals who wouldn't be willing to travel a considerable distance for a personal interview.
								</p>
							<p className="pb-1 mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
								data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700"
								style={{ animationDelay: '700ms' }}>This app's primary goal is to make exam administration faster.
								Normally, conducting an exam requires a lot of infrastructure, but in this case, simply having the application installed suffices.
								</p>
						</div>
